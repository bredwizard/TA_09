...
# LISTA DE IMAGENES DE MONEDA COLECCIONABLE
coin = pygame.image.load("assets/objetos/moneda_0.png")
coin_animation = engine.Animation([
pygame.image.load("assets/objetos/moneda_0.png"),
pygame.image.load("assets/objetos/moneda_1.png"),
pygame.image.load("assets/objetos/moneda_2.png"),
pygame.image.load("assets/objetos/moneda_3.png"),
pygame.image.load("assets/objetos/moneda_4.png"),
pygame.image.load("assets/objetos/moneda_5.png"),
pygame.image.load("assets/objetos/moneda_6.png")
])
